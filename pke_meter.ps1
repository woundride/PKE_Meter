...
Write-Host '                                                                              Version 1.8'
Write-Host '                                                                Release date : 2021/12/29'
...
1{
	do {
		[string]$os_version = 0
		while ( $os_version -lt 1 -or $os_version -gt 19) {
	...
	Write-Host ''
	Write-Host ''
	Write-Host -ForegroundColor Cyan '18 - Computers Statistics'
	Write-Host ''
	...
	7{
			do {
			[string]$10_version = 0
			while ( $10_version -lt 1 -or $10_version -gt 27) {
		Write-Host "    ___"
		Write-Host "'::|_|_|"
		...
		Write-Host '15 - Windows 10 1909 (19H2) Enterprise / Education'
		...
		Write-Host '20 - Windows 11 21H2'
		Write-Host '21 - Windows 11 21H2 Enterprise / Education'
		Write-Host '22 - Windows 10 21H2'
		Write-Host '23 - Windows 10 21H2 Enterprise / Education'
		Write-Host -ForegroundColor Green '24 - Windows 10 21H2 LTSC'
		Write-Host ''
		Write-Host -ForegroundColor Cyan '25 - All Windows 10 versions in 1 file'
		Write-Host -ForegroundColor Cyan '26 - All Windows 10 versions in separated files'
		Write-Host ''
		Write-Host -ForegroundColor Yellow '27 - Return'
		Write-Host ''
		Write-Host '-----------------------------------------------------------------------------------------'
		Write-Host ''
		...
		switch ($10_version) {
			...
			15{
				Write-Host -ForegroundColor Green 'Windows 10 1909 (19H2) Enterprise / Education - End of life : 2022/05/10'
				Write-Host ''
			...
			20{
				Write-Host -ForegroundColor Green 'Windows 11 21H2 - End of life : 2023/10/10'
				Write-Host ''
				...
				Write-Host 'Exported file :'
				Write-Host ''
				Write-Host 'C:\Users\'$user'\Desktop\os_windows_11_21H2.csv'
				Write-Host ''
				Write-Host '-----------------------------------------------------------------------------------------'
				Write-Host ''
			}
			...
			22{
				Write-Host -ForegroundColor Green 'Windows 10 21H2 - End of life : 2023/06/13'
				Write-Host ''
				Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*10*' -and OperatingSystem -Like '*pro*' -and OperatingSystem -NotLike '*LTSC*' -and OperatingSystemVersion -Like '*19044*'} -Properties SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Select SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Export-CSV -Encoding UTF8 C:\Users\$user\Desktop\os_windows_10_21H2.csv
				Write-Host 'Exported file :'
				Write-Host ''
				Write-Host 'C:\Users\'$user'\Desktop\os_windows_10_21H2.csv'
				Write-Host ''
				Write-Host '-----------------------------------------------------------------------------------------'
				Write-Host ''
			}
			...
			26{
				...
				Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*10*' -and OperatingSystem -Like '*pro*' -and OperatingSystem -NotLike '*LTSC*' -and OperatingSystemVersion -Like '*19044*'} -Properties SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Select SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Export-CSV -Encoding UTF8 C:\Users\$user\Desktop\Windows_10\os_windows_10_21H2.csv
	...
	18{
		...
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 8.1 - End of life : 2023/01/10 :' $windows8_1.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		...
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 10 1909 (19H2) Enterprise / Education - End of life : 2022/05/10 :' $windows10_1909_e.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		...
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 10 20H2 - End of life : 2022/05/10 :' $windows10_20h2.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 10 20H2 Enterprise / Education - End of life : 2023/05/09 :' $windows10_20h2_e.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 10 21H1 - End of life : 2022/12/13 :' $windows10_21h1.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 11 21H2 - End of life : 2023/10/10 :' $windows11_21h2.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		...
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 10 21H2 - End of life : 2023/06/13 :' $windows10_21h2.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		...
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows Server 2012 + 2012 R2 - End of life : 2023/10/10 :' $windows2012.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
...
2{
  ...
  while ( $user_extract -lt 1 -or $user_extract -gt 20) {
	Write-Host '      ////^\\\\'
	Write-Host '      | ^   ^ |'
	Write-Host '     @ (o) (o) @'
	Write-Host '      |   <   |'
	...
	Write-Host -ForegroundColor Cyan '19 - Search user by EmployeeID'
	Write-Host ''
