...
Write-Host '                                                                             Version 1.18'
Write-Host '                                                                Release date : 2024/09/22'
...
1{
	...
	7{
			do {
			[string]$10_version = 0
			while ( $10_version -lt 1 -or $10_version -gt 33) {
		Write-Host "    ___"
		Write-Host "'::|_|_|"
		...
		Write-Host -ForegroundColor Red '23 - Windows 10 21H2 Enterprise / Education'
		...
		Write-Host '29 - Windows 11 23H2'
		Write-Host '30 - Windows 11 23H2 Enterprise / Education'
		Write-Host ''
		Write-Host -ForegroundColor Cyan '31 - All Windows 10 versions in 1 file'
		Write-Host -ForegroundColor Cyan '32 - All Windows 10 versions in separated files'
		Write-Host ''
		Write-Host -ForegroundColor Yellow '33 - Return'
		Write-Host ''
		Write-Host '-----------------------------------------------------------------------------------------'
		Write-Host ''
		...
		switch ($10_version) {
			...
			23{
				Write-Host -ForegroundColor Red 'Windows 10 21H2 Enterprise / Education - End of life : 2024/06/11'
				Write-Host ''
				Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*10*' -and OperatingSystem -NotLike '*pro*' -and OperatingSystem -NotLike '*LTSC*' -and OperatingSystemVersion -Like '*19044*'} -Properties SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Select SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Export-CSV -Encoding UTF8 C:\Users\$user\Desktop\unsupported_os_windows_10_21H2_e.csv
				Write-Host 'Exported file :'
				Write-Host ''
				Write-Host 'C:\Users\'$user'\Desktop\unsupported_os_windows_10_21H2_e.csv'
				Write-Host ''
				Write-Host '-----------------------------------------------------------------------------------------'
				Write-Host ''
			}
			...
			29{
				Write-Host -ForegroundColor Green 'Windows 11 23H2 - End of life : 2025/11/11'
				Write-Host ''
				Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*11*' -and OperatingSystemVersion -Like '*22631*'} -Properties SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Select SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Export-CSV -Encoding UTF8 C:\Users\$user\Desktop\os_windows_11_23H2.csv
				Write-Host 'Exported file :'
				Write-Host ''
				Write-Host 'C:\Users\'$user'\Desktop\os_windows_11_23H2.csv'
				Write-Host ''
				Write-Host '-----------------------------------------------------------------------------------------'
				Write-Host ''
			}
			30{
				Write-Host -ForegroundColor Green 'Windows 11 23H2 Enterprise / Education - End of life : 2026/11/10'
				Write-Host ''
				Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*11*' -and OperatingSystem -NotLike '*pro*' -and OperatingSystemVersion -Like '*22631*'} -Properties SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Select SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Export-CSV -Encoding UTF8 C:\Users\$user\Desktop\os_windows_11_23H2_e.csv
				Write-Host 'Exported file :'
				Write-Host ''
				Write-Host 'C:\Users\'$user'\Desktop\os_windows_11_23H2_e.csv'
				Write-Host ''
				Write-Host '-----------------------------------------------------------------------------------------'
				Write-Host ''
			}
			...
			32{
				...
				Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*10*' -and OperatingSystem -NotLike '*pro*' -and OperatingSystem -NotLike '*LTSC*' -and OperatingSystemVersion -Like '*19044*'} -Properties SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Select SamAccountName, LastLogonDate, OperatingSystem, OperatingSystemVersion, CanonicalName | Export-CSV -Encoding UTF8 C:\Users\$user\Desktop\Windows_10\unsupported_os_windows_10_21H2_e.csv
	...
	19{
		...
		$windows11_23h2 = Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*11*' -and OperatingSystem -Like '*pro*' -and OperatingSystemVersion -Like '*22631*'}
		$windows11_23h2_e = Get-ADComputer -Filter {enabled -eq 'true' -and OperatingSystem -Like '*11*' -and OperatingSystem -NotLike '*pro*' -and OperatingSystemVersion -Like '*22631*'}
		...
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Unsupported OS : Windows 10 21H2 Enterprise / Education - End of life : 2024/06/11 :' $windows10_21h2_e.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		...
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 11 23H2 - End of life : 2025/11/11 :' $windows11_23h2.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output 'Windows 11 23H2 Enterprise / Education - End of life : 2026/11/10 :' $windows11_23h2_e.count | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
		Write-Output '-----------------------------------------------------------------------------------------' | Out-File -FilePath c:\Users\$user\Desktop\computers_statistics.txt -Append
...
2{
  ...
  while ( $user_extract -lt 1 -or $user_extract -gt 23) {
	...
	12{
		...
		Search-ADAccount -UsersOnly -AccountExpired -ResultPageSize 2000 -ResultSetSize $null | ? { $_.enabled -eq $true } | Select-Object Name, SamAccountName, LastLogonDate, DistinguishedName, AccountExpirationDate, EmployeeId | Export-CSV -Encoding UTF8 c:\Users\$user\Desktop\all_expired_user_accounts.csv -NoTypeInformation
		Write-Host ''
		Write-Host 'Exported file :'
		Write-Host ''
...
4{
  ...
  while ( $config_extract -lt 1 -or $config_extract -gt 3) {
...
Write-Host '\____||__|_____|__|'
	...
	Write-Host ''
	Write-Host ''
	Write-Host '1 - Informations about the domain'
	Write-Host -ForegroundColor Red '2 - Check last modification date of AdminSDHolder object'
	Write-Host ''
	Write-Host -ForegroundColor Yellow '3 - Return'
	Write-Host ''
	Write-Host '-----------------------------------------------------------------------------------------'
	Write-Host ''
	...
	1{
		Write-Host 'Informations about the domain'
		$TargetDomain = Get-AdDomain | Select Name,DNSRoot,NetBIOSName,DomainMode,PDCEmulator
		Write-Host ''
		Write-Host 'Netbios Name : '-NoNewline; Write-Host -ForegroundColor Cyan $TargetDomain.NetBIOSName
		Write-Host 'DNS Name : ' -NoNewline; Write-Host -ForegroundColor Cyan $TargetDomain.DNSRoot
		Write-Host 'PDC emulator : ' -NoNewline; Write-Host -ForegroundColor Cyan $TargetDomain.PDCEmulator
		Write-Host 'Domain mode (level) : ' -NoNewline; Write-Host -ForegroundColor Cyan $TargetDomain.DomainMode
		Write-Host ''
		Write-Output '-----------------------------------------------------------------------------------------' | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt
		Write-Output 'AdminSDHolder object' | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output '-----------------------------------------------------------------------------------------' | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output 'Netbios Name : '$TargetDomain.NetBIOSName | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output 'DNS Name : '$TargetDomain.DNSRoot | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output 'PDC emulator : '$TargetDomain.PDCEmulator | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output 'Domain mode (level) : '$TargetDomain.DomainMode | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Output '' | Out-File -FilePath c:\Users\$user\Desktop\domain_informations.txt -Append
		Write-Host ''
		Write-Host 'Exported file :'
		Write-Host ''
		Write-Host 'C:\Users\'$user'\Desktop\domain_informations.txt'
		Write-Host ''
		Write-Host '-----------------------------------------------------------------------------------------'
		Write-Host ''
	}
