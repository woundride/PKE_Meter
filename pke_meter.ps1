...
Write-Host '                                                                Release date : 2021/10/09'
...
1{
	do {
		[string]$os_version = 0
		while ( $os_version -lt 1 -or $os_version -gt 18) {
	...
	Write-Host ''
	Write-Host -ForegroundColor Yellow '18 - Return'
	Write-Host
	Write-Host '-----------------------------------------------------------------------------------------'
	Write-Host ''
	...
	7{
			do {
			[string]$10_version = 0
			while ( $10_version -lt 1 -or $10_version -gt 24) {
		Write-Host "    ___"
		Write-Host "'::|_|_|"
		...
		Write-Host ''
		Write-Host -ForegroundColor Cyan '22 - All Windows 10 versions in 1 file'
		Write-Host -ForegroundColor Cyan '23 - All Windows 10 versions in separated files'
		Write-Host ''
		Write-Host -ForegroundColor Yellow '24 - Return'
		Write-Host ''
		Write-Host '-----------------------------------------------------------------------------------------'
		Write-Host ''
