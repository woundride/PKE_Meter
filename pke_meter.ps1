...
Write-Host '                                                                             Version 1.12'
Write-Host '                                                                Release date : 2023/09/12'
...
2{
  ...
  while ( $user_extract -lt 1 -or $user_extract -gt 21) {
	Write-Host '      ////^\\\\'
	Write-Host '      | ^   ^ |'
	Write-Host '     @ (o) (o) @'
	Write-Host '      |   <   |'
	...
	Write-Host -ForegroundColor Cyan '20 - Connexions history for a spedific user'
	Write-Host ''
	...
	20{
		Write-Host -ForegroundColor Cyan 'Connexions history for a specific user'
		Write-Host ''
